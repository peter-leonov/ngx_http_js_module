...
NginxTests.requestHeadersOutSetGet = function (r)
{
	...
	Tests.test('tests for r.headersOut setting and getting', function (t)
	{
		...
		[
			...
			{name: 'Content-Length', value: '123456', nameN: '$contentLengthN', valueN: 123456, deletedN: 0},
			{name: 'Content-Length', value: '1099511627776', nameN: '$contentLengthN', valueN: 1099511627776, deletedN: 0},
			...
			{name: 'Custom-Header', value: 'lalala'}
		]
